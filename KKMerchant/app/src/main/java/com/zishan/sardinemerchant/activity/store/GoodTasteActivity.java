...
public class GoodTasteActivity extends BActivity {
    ...
    protected int getLayoutResId() {
        return R.layout.activity_goods_taste;
    }

    @Override
    public void initActionBar() {
        super.initActionBar();
        setActionbarTitle(getString(R.string.goods_taste));
        ImageView backIcon = setActionBarHomeIcon(R.mipmap.back_white_icon);
        backIcon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //键盘缩回
                SoftInputUtil.hideDirectly(GoodTasteActivity.this);
                finish();
            }
        });
