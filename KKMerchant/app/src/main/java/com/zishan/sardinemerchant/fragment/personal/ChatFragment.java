...
public class ChatFragment extends BaseFragment implements ChatManager.MessageListener {
    ...
    protected static final String TAG = com.hyphenate.helpdesk.easeui.ui.ChatFragment.class.getName();
...
//    protected int[] itemIds = {ITEM_TAKE_PICTURE, ITEM_PICTURE, ITEM_VIDEO, ITEM_FILE};
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(com.hyphenate.helpdesk.R.layout.hd_fragment_chat, container, false);
    }
    ...
    protected void initView() {
        // 消息列表layout
        messageList = (MessageList) getView().findViewById(com.hyphenate.helpdesk.R.id.message_list);
        messageList.setShowUserNick(showUserNick);
        listView = messageList.getListView();
        tvTipWaitCount = (TextView) getView().findViewById(com.hyphenate.helpdesk.R.id.tv_tip_waitcount);
        extendMenuItemClickListener = new MyMenuItemClickListener();
        inputMenu = (EaseChatInputMenu) getView().findViewById(com.hyphenate.helpdesk.R.id.input_menu);
    ...
    protected void setUpView() {
        ...
        titleBar.setRightImageResource(com.hyphenate.helpdesk.R.drawable.hd_mm_title_remove);
    ...
    protected void registerExtendMenuItem() {
        for (int i = 0; i < itemStrings.length; i++) {
            inputMenu.registerExtendMenuItem(itemStrings[i], itemdrawables[i], itemIds[i], 0, extendMenuItemClickListener); //这个需要修改
        }
    }
    ...
    protected void setListItemClickListener() {
        messageList.setItemClickListener(new MessageListItemClickListener() {
            ...
            public void onResendClick(final Message message) {
                new AlertDialog(getActivity(), com.hyphenate.helpdesk.R.string.resend, com.hyphenate.helpdesk.R.string.confirm_resend, null, new AlertDialogUser() {
                    @Override
    ...
    protected void sendFileByUri(Uri uri) {
        ...
        if (file == null || !file.exists()) {
            Toast.makeText(getActivity(), com.hyphenate.helpdesk.R.string.File_does_not_exist, Toast.LENGTH_SHORT).show();
            return;
        }
        //大于10M不让发送
        if (file.length() > 10 * 1024 * 1024) {
            Toast.makeText(getActivity(), com.hyphenate.helpdesk.R.string.The_file_is_not_greater_than_10_m, Toast.LENGTH_SHORT).show();
            return;
        }
    ...
    protected void selectPicFromCamera() {
        if (!CommonUtils.isExitsSdcard()) {
            Toast.makeText(getActivity(), com.hyphenate.helpdesk.R.string.sd_card_does_not_exist, Toast.LENGTH_SHORT).show();
            return;
        }
        try{
    ...
    protected void emptyHistory() {
        String msg = getResources().getString(com.hyphenate.helpdesk.R.string.Whether_to_empty_all_chats);
