...
import com.zishan.sardinemerchant.activity.personal.customer_service.BaiduMapActivity;
import com.zishan.sardinemerchant.view.ChatRowLocation;
...
//                return true;
    ...
    protected void registerExtendMenuItem() {
        ...
        //增加扩展的item
        inputMenu.registerExtendMenuItem(R.string.attach_location, R.drawable.hd_chat_location_selector, ITEM_MAP, 0, extendMenuItemClickListener); //需要修改
//        inputMenu.registerExtendMenuItem(R.string.leave_title, R.drawable.em_chat_phrase_selector, ITEM_LEAVE_MSG,  0,extendMenuItemClickListener);
//        inputMenu.registerExtendMenuItem(R.string.attach_call_video, R.drawable.em_chat_video_selector, ITEM_VIDEO,  0,extendMenuItemClickListener);
