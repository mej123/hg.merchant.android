...
public class StoreManageActivity extends BActivity<GoodsListView, GoodsListPresenter>
    ...
    private class StoreFragmentPagerAdapter extends FragmentStatePagerAdapter {
        ...
        public void removeFragment(ProductGroupEntity productGroup) {
            ...
            GoodsListFragment fg = goodsListFragment.get(index);
            goodsListFragment.remove(fg);
    ...
    public void initActionBar() {
        ...
        setActionbarTitle(getString(R.string.goods_manager));
        setActionBarMenuIcon(R.mipmap.add_icon).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                //商品添加
                Intent intent = new Intent(StoreManageActivity.this, StoreGoodsAddActivity.class);
    ...
    protected void initContentView() {
        ...
        mPagerAdapter = new StoreFragmentPagerAdapter(getSupportFragmentManager(), mProductGroups, mGoodFragments);
        ...
        switch (view.getId()) {
            ...
            case R.id.store_separate_manager:
                if (!permissionAllowed(5)) {
                    ...
                    Intent intent = new Intent(this, ClassifyManageActivity.class);
