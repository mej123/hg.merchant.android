...
public class TableTransformAdapter extends RecyclerView.Adapter<TableTransformAdapter.ViewHolder> {


    private List<StoreSeatEntity> mDataList;
    private LayoutInflater mInflater;

    public TableTransformAdapter(Context context, List<StoreSeatEntity> dataList) {
