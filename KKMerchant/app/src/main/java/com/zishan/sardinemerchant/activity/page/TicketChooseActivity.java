...
public class TicketChooseActivity extends BActivity<CouponListView, CouponPresenter>
        implements CouponListView {

    @BindView(R.id.choose_ticket_springview)
    SpringView mSpringView;
    @BindView(R.id.choose_ticket_recycler_view)
    RecyclerView mRecycler;
    @BindView(R.id.empty_ticket_release_layout)
    ...
    public void initActionBar() {
        ...
        TextView titleText = setActionbarTitle(getString(R.string.choose_ticket));
    ...
    protected void initContentView() {
        ...
        mAdapter = new TicketChooseAdapter(R.layout.item_choose_ticket, mDataList, false);
        ...
        mAdapter.setOnRecyclerViewItemClickListener(
                new BaseQuickAdapter.OnRecyclerViewItemClickListener() {
                    ...
                    public void onItemClick(View view, int position) {
                        ...
                        if(data == null) return;
                        Intent intent = new Intent(TicketChooseActivity.this, TicketAddActivity.class);
    ...
    private void initRequestCouponList() {
        mCurrentPage = 0;
        mPresenter.getCouponList(UserConfig.getInstance(ClientApplication.getApp()).getMerchantId(),
