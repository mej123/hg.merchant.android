...
import com.zishan.sardinemerchant.adapter.BaseDropMenuAdapter;
...
public class DropMenuLayout extends LinearLayout {
    ...
    private List<BaseDropMenuEntity> mDataList = new ArrayList<>();
    private DropMenuListener mDropMenuListener;
    ...
    public DropMenuLayout(Context context, @Nullable AttributeSet attrs) {
        ...
        mAdapter = new BaseDropMenuAdapter(R.layout.item_appointment_select, mDataList);
    }
    ...
    public void setDropMenuListener(DropMenuListener listener) {
        this.mDropMenuListener = listener;
    }
