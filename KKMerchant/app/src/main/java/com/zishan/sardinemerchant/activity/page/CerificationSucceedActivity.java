...
public class CerificationSucceedActivity extends BaseFragmentActivity {// implements EasyPermissions.PermissionCallbacks
    ...
    private List<CouponProductEntity> mDataList = new ArrayList<>();
    ...
    protected int getLayoutResId() {
        return R.layout.activity_cerification_succeed;
    }
    ...
    protected void initContentView() {
        ...
        if (intent != null) {
            List<CouponProductEntity> dataList = intent.getParcelableArrayListExtra("products");
        ...
        if (requestCode == REQUEST_CODE) {
            ...
            if (null != data) {
                ...
                if (bundle.getInt(CodeUtils.RESULT_TYPE) == CodeUtils.RESULT_SUCCESS) {
                    ...
                    Skip.toActivity(CerificationSucceedActivity.this, ScanCodeResultActivity.class);
                    Toast.makeText(this, "解析结果:" + result, Toast.LENGTH_LONG).show();
                } else if (bundle.getInt(CodeUtils.RESULT_TYPE) == CodeUtils.RESULT_FAILED) {
                    Skip.toActivity(CerificationSucceedActivity.this, ScanCodeResultActivity.class);
                    Toast.makeText(CerificationSucceedActivity.this, "解析二维码失败", Toast.LENGTH_LONG).show();
                }
            }
        }
                ...
                try {
                    CodeUtils.analyzeBitmap(ImageUtil.getImageAbsolutePath(this, uri), new CodeUtils.AnalyzeCallback() {
                        ...
                        public void onAnalyzeSuccess(Bitmap mBitmap, String result) {
                            //解析结果
                            Toast.makeText(CerificationSucceedActivity.this, "解析结果:" + result, Toast.LENGTH_LONG).show();
                        }
...
//            onClick(viewId);
            Intent intent = new Intent(CerificationSucceedActivity.this, QRcodeActivity.class);
